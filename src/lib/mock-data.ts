...
export const items: Item[] = [
  ...
  },
  {
    ...
    description: "Prompt to analyze and optimize complex PostgreSQL queries",
    itemType: ItemType.Prompt,
    collectionId: "2",
  ...
  },
  {
    ...
    description: "A secure snippet for validating Stripe webhook signatures",
    itemType: ItemType.Snippet,
    collectionId: "1",
    tags: ["#stripe", "#backend"],
  ...
  },
  {
    ...
    description: "Useful commands for debugging pods and deployments",
    itemType: ItemType.Command,
    collectionId: "3",
    tags: ["#k8s", "#devops"],

        ...
        <div className="grid lg:grid-cols-[1.5fr_1fr_1fr_1fr] gap-10 mb-10">
          <div>
            ...
            <p className="text-sm text-muted-foreground max-w-xs leading-relaxed mb-4">
              The developer knowledge hub. Stop losing your best code, prompts,
              and commands across a dozen tools.
            </p>
...
function SocialIcon({
  ...
  return (
    <a
      href={href}
      aria-label={label}
      className="w-8 h-8 rounded-lg border border-white/10 hover:border-white/30 flex items-center justify-center text-muted-foreground hover:text-foreground transition-colors"
    >
